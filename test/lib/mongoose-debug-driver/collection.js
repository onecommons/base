...
/*
XXX ensureIndex getIndexes

findAndModify; needs to support 'new' 'upsert' and 'remove 'as options

save: upsert, replaces whole document
...
NativeCollection.prototype.ensureIndex = function(){
...
NativeCollection.prototype.findOne = function(){
...
NativeCollection.prototype.find = function(){
...
NativeCollection.prototype.save = function(){
...
NativeCollection.prototype.update = function(){
...
NativeCollection.prototype.getIndexes = function(){
...
NativeCollection.prototype.mapReduce = function(){
  throw new Error('Collection#mapReduce unimplemented by driver');
};

/* missing from collections.js, see mquery/collection:
 */
...
NativeCollection.prototype.count = function(){
  throw new Error('Collection#update unimplemented by driver');
}

NativeCollection.prototype.distinct = function(){
  throw new Error('Collection#update unimplemented by driver');
}

NativeCollection.prototype.aggregate = function(){
  throw new Error('Collection#aggregate unimplemented by driver');
}
...
for (var i in Collection.prototype) {
  (function(i){
    NativeCollection.prototype[i] = function () {
      ...
      if (!this.synced) {
        //console.log('syncing', i, this.conn.models[this.name].prototype.schema)
        //this.syncSchema();
        this.synced = true;
      }
