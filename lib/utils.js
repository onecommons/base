...
exports.sharedPageVars = function(req, res, next) {
  ...
  merge(res.locals, exports.getVars());
  res.locals.routes = _.object(_.map(this.get("namedRoutes"), function(value, key){ return [key, path.join('/', value.path)]; }));
