...
RequestHandler.prototype.add = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.remove = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.destroy = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.replace = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.update = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.create = function(mjson, respond, p, req) {
    var This = this;
...
RequestHandler.prototype.query = function(mjson, respond, p, req) {
    var This = this;
